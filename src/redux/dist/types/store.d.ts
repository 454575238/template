 ...
 */
export declare type ExtendState<State, Extension> = [Extension] extends [never]
  ? State
  : State & Extension
/**
 ...
 */
export declare type StoreEnhancerStoreCreator<Ext = {}, StateExt = never> = <
  S = any,
  A extends Action = AnyAction
>(
  reducer: Reducer<S, A>,
...
export declare type StoreEnhancer<Ext = {}, StateExt = never> = (
